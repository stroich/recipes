...
const Index: FC<IndexProps> = ({ posts, articles }) => {
  ...
  return (
    <HomeLayout
      title={'Кушать будешь? Все рецепты для правильного питания'}
      description={
        'Наши вкусные и здоровые рецепты помогут вам достичь баланса в питании. Изучайте разнообразные блюда, советы по питанию для поддержания активного и счастливого образа жизни.'
      }
      keywords={
        'Рецепты для правильного питания, правильное питание, рецепты для похудения, диетические блюда, низкокалорийные рецепты, завтраки для здорового питания, вегетарианство, похудение, сбалансированная диета, здоровое меню'
      }
    >
